 ...
 *
 * This test runner allows us to split our tests by BRTAPI method, and
 ...
 */
describe('BRTAPI [Test Runner]', function () {
  beforeEach(setupAPI.setup)
  afterEach(setupAPI.teardown)

  // Collect all the tests:
  const allPublicMethods = getAllPublicMethods(new BRTAPI())
